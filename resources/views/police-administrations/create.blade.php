...
@section('title', __('ui.police_administrations.add_administration'))

@section('content_header')
    <h1>{{ __('ui.police_administrations.add_administration') }}
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('police-administrations.store') }}" method="POST">
            @csrf
